...
return function (ContainerConfigurator $container) {
    ...
    $p
        ('routes',                      [])
        ('routes.cached',               '%env(PANTHOR_APPROOT)%/configuration/routes.cached.php')
    ...
    $s
        ...
        ('router.loader', RouteLoader::class)
            ->arg('$routes', '%routes%')
        ...
        ('error.handler', ErrorHandler::class)
            ->arg('$handler', ref('exception.handler'))
            ->arg('$logger', ref('logger'))
        ...
        ('cookie.handler', CookieHandler::class)
    ...
    $s
        ('panthor.middleware.encrypted_cookies', EncryptedCookiesMiddleware::class)
